    ...
    var _new = function (year, month, day, hour, minute, second, solar, ly) {
      ...
      return {
        ...
        getDayJiShen: function () {
          return LunarUtil.getDayJiShen(
            this.getMonthZhiIndex(),
            this.getDayInGanZhi(),
          );
        },
    ...
    var _new = function (
      ...
      return {
        _p: {
          ...
          index: index,
          zhiIndex:
            (Math.abs(lunarMonth) - 1 + LunarUtil.BASE_MONTH_ZHI_INDEX) % 12,
        },
        getIndex: function () {
          return this._p.index;
        },
  ...
  var ShouXingUtil = (function () {
    ...
    return {
      ...
      DT_AT: [
        ...
        0, 2012, 66.8, 0.22, 0, 0,
        // 2018, 69.0, 0.36, 0, 0,
        // 使用skyfeild的DE440s△T预测数据拟合
        2016, 68.1024, 0.5456, -0.0542, -0.001172, 2020, 69.3612, 0.0422,
        -0.0502, 0.006216, 2024, 69.1752, -0.0335, -0.0048, 0.000811, 2028,
        69.0206, -0.0275, 0.0055, -0.000014, 2032, 68.9981, 0.0163, 0.0054,
        0.000006, 2036, 69.1498, 0.0599, 0.0053, 0.000026, 2040, 69.4751,
        0.1035, 0.0051, 0.000046, 2044, 69.9737, 0.1469, 0.005, 0.000066, 2048,
        70.6451, 0.1903, 0.0049, 0.000085, 2050, 71.0457,
      ],
      XL0: [
      ...
      calcQi: function (jd) {
        ...
        if (jd < f1 || jd >= f3) {
          d = Math.floor(
            this.qiHigh(
              (Math.floor(((jd + pc - 2451259) / 365.2422) * 24) * Math.PI) /
                12,
            ) + 0.5,
          );
        } else if (jd >= f1 && jd < f2) {
  ...
  var LunarUtil = (function () {
    return {
      ...
      getDayJiShen: function (monthZhiIndex, dayGanZhi) {
        ...
        var matcher = new RegExp(";" + index + "(.[^;]*)", "g").exec(
          this.DAY_SHEN_SHA[m],
        );
        if (matcher) {
          var data = matcher[1];
